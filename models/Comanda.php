...
class Comanda
{
    ...
    {
        $objetoAccesoDato = ConexionPDO::obtenerInstancia();
        $consulta = $objetoAccesoDato->prepararConsulta("INSERT INTO relacion_pedido_producto (id_producto, id_pedido) VALUES $valuesString");
        $resultado = $consulta->execute();
    ...
    public static function IncrementarCantPedido($valores) {
        ...
        foreach ($valores as $item) {        
            $objetoAccesoDato = ConexionPDO::obtenerInstancia();
            $consulta = $objetoAccesoDato->prepararConsulta("UPDATE productos SET cant_pedido = cant_pedido + 1 WHERE id = :productoId");
    ...
    {
        $objetoAccesoDato = ConexionPDO::obtenerInstancia();
        $consulta = $objetoAccesoDato->prepararConsulta("SELECT id_producto FROM relacion_pedido_producto WHERE id_pedido = :idPedido");
    ...
    {
        $objetoAccesoDato = ConexionPDO::obtenerInstancia();
        $consulta = $objetoAccesoDato->prepararConsulta("SELECT * FROM pedidos WHERE tiempo_retraso != '00:00:00'");
        $consulta->execute();
